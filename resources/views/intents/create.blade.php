...
<head>
    ...
    <title>Tambah Intent Baru - Notary Bot</title>
...
<body>
    <div class="container">
        <h1 class="mb-4"><i class="bi bi-plus-circle"></i> Tambah Intent Baru</h1>
        ...
        <form action="{{ route('intents.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="description" name="description" 
                          rows="2" placeholder="Deskripsi singkat tentang intent ini">{{ old('description') }}</textarea>
            </div>

            <div class="mb-3">
                <label for="priority" class="form-label">Priority</label>
                <input type="number" class="form-control" id="priority" name="priority" 
                       value="{{ old('priority', 500000) }}" placeholder="500000">
            ...
            <div class="mb-4">
                ...
                <div id="training-phrases-container">
                    @if(old('training_phrases'))
                        @foreach(old('training_phrases') as $index => $phrase)
                            <div class="phrase-item input-group">
                                <input type="text" class="form-control" name="training_phrases[]" 
                                       value="{{ $phrase }}" placeholder="Contoh: Halo" required>
            ...
            <div class="mb-4">
                ...
                <div id="input-contexts-container">
                    @if(old('input_contexts'))
                        @foreach(old('input_contexts') as $index => $context)
            ...
            <div class="mb-4">
                ...
                <div id="output-contexts-container">
                    @if(old('output_contexts'))
                        @foreach(old('output_contexts') as $index => $context)
            ...
            <div class="mb-4">
                ...
                <div id="responses-container">
                    @if(old('responses'))
                        @foreach(old('responses') as $index => $response)
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="action" name="action" 
                       value="{{ old('action') }}" placeholder="Contoh: greeting.action">
            ...
            <div class="mb-3 form-check">
                <input type="checkbox" class="form-check-input" id="webhook_enabled" 
                       name="webhook_enabled" value="1" {{ old('webhook_enabled') ? 'checked' : '' }}>
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-save"></i> Simpan Intent
                </button>
    ...
    <script>
        ...
        document.getElementById('add-phrase').addEventListener('click', function() {
            ...
            newPhrase.innerHTML = `
                <input type="text" class="form-control" name="training_phrases[]" 
                       placeholder="Contoh: Halo" required>
                <button type="button" class="btn btn-remove remove-phrase">
                    <i class="bi bi-x"></i>
                </button>
            `;
        ...
        // Add Output Context
        let outputContextIndex = {{ old('output_contexts') ? count(old('output_contexts')) : 0 }};
